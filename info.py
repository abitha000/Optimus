...
# Bot information
API_ID = environ.get('API_ID', '24401235')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '149f7e13d7d861b27cffc3ab1fd52b22') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7286009662:AAEBooZev-M7Ib2mJD-vJtMYKvmclJlNy0k') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '7255612720') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002237503909').split()]
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002183761611') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002192455941') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://karjr002:cksxRBVwMBNWG4bL@cluster0.c10vtnq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongo db url
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/Scarlett_request')
